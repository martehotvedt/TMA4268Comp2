...
where $\mathbf{Y}$ is a $(918 \times 1)$ vector of responses (age), $\beta$ is a $(12 \times 1)$ of regression parameters, and $\epsilon$ is a $(918 \times 1)$ vector of random errors. $\mathbf{X}$ is the $(918 \times 12)$ design matrix given by
...
where row $i$ contains a $(12 \times 1)$ vector $x^T_i$ for observation $i$. We assume that the $\epsilon \sim N_{918}(0, \sigma^2\mathbf{I})$.
