...
where $\mathbf{Y}$ is a $(n \times 1)$ vector of responses (age), $\mathbf{X}$ is the $(n \times (p+1))$ design matrix, $\beta$ is a $((p+1) \times 1)$ of regression parameters, and $\epsilon$ is a $(n \times 1)$ vector of random errors. 
